package com.crisdev.algadelivery.courier.management.domain.model;
...
public class Courier {
    ...
    private Integer fulfillledDeliveriesQuantity;

    private Integer pendinDeliveriesQuantity;
    ...
    public static Courier brandNew(String name, String phone) {
        ...
        courier.setPendinDeliveriesQuantity(0);
        courier.setFulfillledDeliveriesQuantity(0);
        return courier;
    ...
    public void fulfill(UUID deliveryId) {
        ...
        this.pendinDeliveriesQuantity--;
        this.fulfillledDeliveriesQuantity++;
