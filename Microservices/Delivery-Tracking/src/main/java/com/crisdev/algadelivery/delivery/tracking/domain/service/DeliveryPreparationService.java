...
import com.crisdev.algadelivery.delivery.tracking.api.model.DeliveryInput;
import com.crisdev.algadelivery.delivery.tracking.api.model.ItemInput;
import com.crisdev.algadelivery.delivery.tracking.domain.exception.DomainException;
import com.crisdev.algadelivery.delivery.tracking.domain.model.ContactPoint;
import com.crisdev.algadelivery.delivery.tracking.domain.model.Delivery;
import com.crisdev.algadelivery.delivery.tracking.domain.repository.DeliveryRepository;
...
public class DeliveryPreparationService {
    ...
    private final DeliveryTimesEstimationService deliveryTimesEstimationService;
    ...
    private void handlePreparation(DeliveryInput input, Delivery delivery) {
        ContactPoint senderInput = input.getSender();
        ContactPoint recipientInput = input.getRecipient();
        ...
        DeliveryEstimate estimate = deliveryTimesEstimationService.estimate(sender, recipient);
