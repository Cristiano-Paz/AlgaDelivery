package com.crisdev.algadelivery.delivery.tracking.domain.model;
...
public class Delivery {
    ...
    private void verifyIfCanBePlace() {
          if (!isFilled()) {
    ...
    private boolean isFilled() {
        return this.getSender() != null && this.getRecipient()
                != null && this.getTotalCost() != null;
